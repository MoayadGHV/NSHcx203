module counter_4bit#(
    ...
    output logic [3:0] count
        ...
        assign next_count[2] = (count[0] & count[1]) ^ count[2]; //removed ~ from count0
        assign next_count[3] = (count[0] & count[1] & count[2])  ^ count[3]; //removed ~ from count2
        ...
        d_flipflop dff2(
            .clk(clk),
            .D(dff2_data_i), // this was missing
            .reset_n(reset_n),
            .Q(count[2])
            );
